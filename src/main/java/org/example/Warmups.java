...
````*/
   ...
   Given 2 int values greater than 0, return whichever value is nearest to 21 without going over. Return 0 if they both go over.
    ...
    string appear somewhere else in the string? Assume that the string is not empty and that N is in the range 1..str.length().
    ...
    public boolean prefixAgain(String str, int n) {
        String stringToLookFor = str.substring(0,n);
        int firstStr = str.indexOf(stringToLookFor);
        int lastStr = str.lastIndexOf(stringToLookFor);
